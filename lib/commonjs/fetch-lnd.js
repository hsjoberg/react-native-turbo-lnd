...
const lndDownloadUrl = "https://github.com/hsjoberg/react-native-turbo-lnd/releases/download/0.0.0";
...
async function setupAndroidBinaries() {
  const jniLibsPath = path.join(process.cwd(), "android", "app", "src", "main", "jniLibs");
  await fsp.mkdir(jniLibsPath, {
    recursive: true
  });
  ...
  if (missingArchitectures.length > 0) {
    console.warn(`Warning: Missing architectures: ${missingArchitectures.join(", ")}`);
  } else {
...
main();
//# sourceMappingURL=fetch-lnd.js.map