...
import { ChannelSchema, Peer_SyncType, CommitmentType, ChannelConstraintsSchema, PeerSchema, FeatureSchema, TimestampedErrorSchema, WalletBalanceResponseSchema, GetInfoResponseSchema, AddressType, ChannelBalanceResponseSchema, PendingChannelsResponseSchema, AmountSchema, WalletAccountBalanceSchema } from "../proto/lightning_pb.js";
...
export const mockChannels = [create(ChannelSchema, {
  active: true,
...
export const mockPeers = [create(PeerSchema, {
  ...
  errors: [create(TimestampedErrorSchema, {
...
export const generateMockAddress = type => {
  const prefix = (() => {
    switch (type) {
...
const createMockAmount = (sat, msat) => create(AmountSchema, {
  sat: BigInt(sat),
  msat: BigInt(msat)
});
...
export const mockPendingChannelsResponse = create(PendingChannelsResponseSchema, {
