 ...
 * @return {string}
 */
export function decodeFallback(bytes: Uint8Array) {
  var inputIndex = 0;
  ...
  for (;;) {
    ...
    if (!more || pendingIndex >= pendingSize - 1) {
      ...
      chunks.push(String.fromCharCode.apply(null, arraylike as any));
 ...
 * @return {Uint8Array}
 */
export function encodeFallback(string: string) {
  var pos = 0;
